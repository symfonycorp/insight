...
class Analysis
{
     ...
     * @SerializedName("previous-analysis-references")
     */
    private $previousAnalysisReferences;
    ...
    public function getPreviousAnalysisReferences()
    {
        return $this->previousAnalysisReferences;
    }
}
